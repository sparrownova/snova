...
@click.option(
	...
	"sparrow_branch",
	default=None,
	help="Clone a particular branch ofsparrow",
)
@click.option(
...
@click.option("--sparrow-path", default=None, help="path tosparrow repo")
...
@click.command("new-app", help="Create a newSparrow application under apps folder")
@click.option(
	"--no-git",
	is_flag=True,
	flag_value="--no-git",
	help="Do not initialize git repository for the app (available inSparrow v14+)",
)
