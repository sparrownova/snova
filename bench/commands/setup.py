...
@click.group(help="Setup command group for enabling setting up aSparrow environment")
def setup():
	pass
...
@click.command("fonts", help="AddSparrow fonts to system")
def setup_fonts():
...
@click.command(
	"production", help="SetupSparrow production environment for specific user"
)
@click.argument("user")
