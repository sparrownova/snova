...
def is_version_upgrade(app="sparrow", bench_path=".", branch=None):
...
def get_current_sparrow_version(bench_path="."):
	try:
		return get_major_version(get_current_version("sparrow", bench_path=bench_path))
	except OSError:
		return 0
